...
class PolicyCenter final : public Module {
 ...
 PolicyCenter() : Module() {}
  ...
  void create_mapping(bess::Packet*, struct tcp_session*);
  void restore_super_session(bess::Packet*, struct tcp_session*);
  void ProcessBatch(bess::PacketBatch*) override;
  
 private:
  using HashTable = bess::utils::CuckooMap<struct tcp_session, struct tcp_session, struct tcp_session::Hash, struct tcp_session::EqualTo>;
  HashTable map;
};
